...
13 | Kas minu andmete töötlus teie süsteemides on minimaalne (õiguspäraste eesmärkide suhtes)? | Tõenäoliselt ei oska inimene seda küsida. Siiski on see sisuliselt oluline küsimus.
...
Mis suunas turg areneb, on raske ennustada. Kas tekivad GDPR-_compliant_ tooted või eraldi lahendused või mõlemad. Prognoosin siiski GDPR-turu tõusu. 

Millised GDPR-lahendusi praegu avalikule sektorile pakutakse?
...
Kaarditus näitab, et tabel on veel üsna tühi. Informatiseerimise ja automatiseerimise võimalusi on siiski praktiliselt kõigi küsimuste juures. Andmesubjekte, kes kõik on potentsiaalsed küsijad, on palju. Ilma IT-ga s.o käsitsitööga ei ole  küsimused vastatavad.
